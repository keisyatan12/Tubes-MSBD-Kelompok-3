...
<div class="edit text-sm-end"><a href="/tambahsiswa-adminMU" type="button" class="btn btn-secondary mt-3 mb-3" ><i class="fa-solid fa-file-pen" style="color: #ffffff;"></i> Tambah  Siswa</a></div>
   ...
   <table  class="table text-center table-bordered  mt-4"style="width:900px ;" >
     ...
     <tbody >
       <tr>
         ...
         <td>21123356</td>
         <td>Aktif</td>
         <td><a type="button"  href="/detailsiswa-adminMU"  class="btn btn-warning">Lihat Detail</a></td>
         <td>
