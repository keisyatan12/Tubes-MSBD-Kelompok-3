 ...
 <table  class="table text-center table-bordered  mt-4"style="width:900px ;" >
   ...
   <tbody >
     <tr>
       <th scope="row">1</th>
       <td>7-A</td>
       <td><a type="button"  href="/jadwalsiswa-admin"  class="btn btn-warning">Lihat Jadwal</a></td>
     </tr>
     <tr>
       <th scope="row">2</th>
       <td>7-B </td>
     ...
     <tr>
       <th scope="row">3</th>
       <td>7-C</td>
       <th scope="row"><a type="button" href="/jadwalsiswa-admin" class="btn btn-warning" >Lihat Jadwal </a></th>
     </tr>
     <tr>
         <th scope="row">4</th>
         <td>8-A</td>
