...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/jadwalmengajarguru"  data-target="#collapseTwo"
            ...
            <!-- Rapor-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/raporsiswaguru"  data-target="#collapseUtilities"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/profilelengkapguru"  data-target="#collapsePages"
