...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/jadwalsiswa"  data-target="#collapseTwo"
            ...
            <!-- Rapor-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/raporsiswa"  data-target="#collapseUtilities"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/profilesiswa"  data-target="#collapsePages"
