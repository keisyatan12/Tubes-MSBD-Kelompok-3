...
<br>
             ...
             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/daftarkelassiswa-adminMU">SISWA</a>
                        <a class="collapse-item" href="/daftarptk-adminMU">PTK</a>
                        <a class="collapse-item" href="/daftartu-adminMU">Tata Usaha</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nilai -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/listraporsiswa-admin"  data-target="#collapseTwo"
             ...
             <!-- Jadwal -->
             <li class="nav-item">
                <a class="nav-link collapsed" href="/daftarkelassiswa-adminJS"  data-target="#collapseTwo"
                     aria-expanded="true" aria-controls="collapseTwo">
           ...
           <li class="nav-item">
            ...
            <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/daftarekskul-admin">Daftar Ekstrakurikuler</a>
                    <a class="collapse-item" href="/daftarekskulsiswa-admin">Ekstrakurikuler Siswa</a>
                </div>
            </div>
             ...
             <!-- Profile -->
             <li class="nav-item">
                 <a class="nav-link collapsed" href="/audit-admin"  data-target="#collapsePages"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/profile-admin"  data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
